...
from agents import stt, tokenize, tts, utils, vad
from agents._constants import ATTRIBUTE_AGENT_STATE
from agents._types import AgentState
from agents.llm import LLM, ChatContext, ChatMessage, FunctionContext, LLMStream
    ...
    def __init__(
        ...
        *,
        ...
        if not stt.capabilities.streaming:
            from agents import stt as speech_to_text
